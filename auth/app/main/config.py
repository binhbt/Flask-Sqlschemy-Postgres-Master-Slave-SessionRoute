...
POSTGRES_HOST_SLAVE = os.getenv('POSTGRES_AUTH_HOST_SLAVE', '127.0.0.1')
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI_SLAVE = "postgresql+psycopg2://{user}:{password}@{host}:{port}/{database}".format(
        user=POSTGRES_USER,
        password=POSTGRES_PASSWORD,
    ...
    SQLALCHEMY_BINDS ={'slave': SQLALCHEMY_DATABASE_URI_SLAVE}
...
# SEND MAIL
MAIL_USERNAME = 'support@kidago.pl'
...
KIDAGO_FRONT_END_ADDR=os.getenv('KIDAGO_FRONT_END_ADDR', 'http://188.166.214.37:3000')
